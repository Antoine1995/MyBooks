...
<p>		
	<div id="main_menu">
		<ul id=index>
			...
			<li id=al> <a class="<?php echo ($current_page == 'Gallery.php' || $current_page == '') ? 'active' : NULL ?>" href="Gallery.php"> Gallery </a> </li></br>
			<li id=al> <a class="<?php echo ($current_page == 'Comment.php' || $current_page == '') ? 'active' : NULL ?>" href="Comment.php"> Comment </a> </li></br>
		</ul>
	</div>
</p>
